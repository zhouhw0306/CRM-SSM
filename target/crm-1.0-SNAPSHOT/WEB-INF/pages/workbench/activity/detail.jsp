            ...
            $.ajax({
                ...
                success:function (data) {
                    ...
                    if (data.success==1){
                        ...
                        html += '<a class="myHref" href="javascript:void(0);" onclick="editRemark1(\''+data.ar.id+'\')"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: skyblue;"></span></a>';
                        html += '&nbsp;&nbsp;&nbsp;&nbsp;';
		...
		$.ajax({
			...
			success: function (data) {
				...
				$.each(data,function (i,n) {
				    ...
				    html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
					html += '<a class="myHref" href="javascript:void(0);" onclick="editRemark(\''+n.id+'\')"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: skyblue;"></span></a>';
					html += '&nbsp;&nbsp;&nbsp;&nbsp;';
	    ...
	    $.ajax({
            ...
            success: function (data){
                ...
                if (data){
                    ...
                    //showRemarkList();(这种方法不行, 记录使用的是before方法, 每一次删除之后, 页面上都会保留原有的数据)
                    $("#"+id).remove();
                }else {
                    alert("删除备注失败")
                }
